 ...
 * <a href="https://adventofcode.com/2023/day/3">AoC page</a>.
 */
public class Day03 {
    private final static int NUMERIC_ZERO = (int) '0';
    private final static int NUMERIC_NINE = (int) '9';
    private final static int NUMERIC_DOT = (int) '.';
    ...
    public static int part2(List<String> input) {
        ...
        return gears.keySet().stream().map(gear -> {
            var a = getPointsArround(gear, gear).stream()
    ...
    private static int getAdjacentSymbolExists(Map<Point, Character> symbols, String number, Point startNumber,
            Point endNumber) {
        boolean adjacentSymbolExists = getPointsArround(startNumber, endNumber)
                .stream()
