...
/**
 * My solution for day 4 of Advent of Code 2023. The puzzle can be found at the <a
 * href="https://adventofcode.com/2023/day/4">AoC page</a>.
 */
public class Day04 {
  ...
  public record CardNumber(String[] numbers) {
    ...
    public IntStream asIntStream() {
      return asStream().mapToInt(num -> Integer.valueOf(num));
    }
  }
  ...
  public static int part2(List<String> input) {
    List<Card> cards = input.stream().map(line -> new Line(line).getCard()).toList();
    Map<Integer, Integer> map =
        cards.stream().collect(Collectors.toMap(card -> card.idAsInt(), card -> 1));
